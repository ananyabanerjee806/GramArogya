...
import { toggleImportantPrescription, deletePrescription } from "@/actions/prescriptions";
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto p-0 rounded-2xl">
        {/* Header */}
        <div className="p-6 pb-4 border-b border-slate-100 bg-slate-50/50 dark:bg-slate-900/50 dark:border-slate-800 flex items-start justify-between">
