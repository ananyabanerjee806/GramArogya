...
import { ClinicalSuiteDashboardWidget } from "@/components/dashboard/clinical-suite-widget";
...
export function DashboardClientView({
  ...
  return (
    <div className="space-y-8">
      {/* Live Interactive Next-Gen Clinical AI Suite */}
      <ClinicalSuiteDashboardWidget />
